...
function onLocalTracks(tracks) {
    ...
    for (let i = 0; i < localTracks.length; i++) {
        ...
        if (localTracks[i].getType() === 'video') {
            $('#container')
                .append(`<div class="video ffloat-left"><div class="in">ee</div><video autoplay='1' id='localVideo${i}' /></div>`);
...
function onRemoteTrack(track) {
    ...
    if (track.getType() === 'video') {
        $('#container')
            .append(
                `<div class="video ffloat-left video_${participant}"><div class="in">ee</div><video autoplay='1' id='${id}' /></div>  `);
    } else {
        $('#container')
            .append(
...
function onUserLeft(id) {
    ...
    for (let i = 0; i < tracks.length; i++) {
        ...
        console.error(document.getElementById(`#${id}${tracks[i].getType()}${i+1}`));
        tracks[i].detach(document.getElementById(`#${id}${tracks[i].getType()}${i+1}`));
    }
